...
ALIEN_IMAGES1   = ('alien1.png','alien2.png','alien3.png')
...
SHIP_IMAGE2    = 'ship-strip.png'

# The alternate images to use in the filmstrip
ALIEN_IMAGES2   = ('alien-strip1.png','alien-strip2.png','alien-strip3.png')
